            ...
            */
            switch (browser){
                ...
                case "edge":
                    ...
                    break;
                case "safari":
                    if (!System.getProperty("os.name").toLowerCase().contains("mac")) throw new WebDriverException("Your OS doesn't support Safari");
                ...
                case "remote-chrome":
                    ...
                    String gridAdress = "localhost"; // put your own Linux grid IP here
                    try {
