...
Feature: Login function
  ...
  Scenario: Verify that user shouldn't be able to sign up with already existing credentials
    When user logs in with valid username and invalid password "username" "password"
    Then user should see "Wrong password." message

  @US2_LOG3
  Scenario: Verify that user shouldn't be able to sign up with already existing credentials
    When user logs in with invalid username and valid password "username" "password"
  ...
  Scenario: Verify that user shouldn't be able to login without clicking login button
    When user logs in with valid credentials without clicking login button "username" "password"
  ...
  Scenario: User should see the password in bullet signs by default
    When user enters a valid password "test"
